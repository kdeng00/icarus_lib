...
album_repository::album_repository(const models::conn_string &conn_str, const std::string table) : 
    base_repository(conn_str, table)
{
}

album_repository::album_repository(const models::binary_path &conn_str, const std::string table) : 
    base_repository(conn_str, table)
{
}

std::vector<models::album> album_repository::retrieveRecords()
{
...
std::pair<models::album, int> album_repository::retrieveRecordWithSongCount(models::album &album, types::album_filter filter)
{
...
models::album album_repository::retrieveRecord(models::album &album, types::album_filter filter)
{
...
bool album_repository::doesAlbumExists(const models::album &album, types::album_filter filter)
{
    auto conn = this->setup_connection();
    auto stmt = mysql_stmt_init(conn);
...
void album_repository::saveAlbum(const models::album &album)
{
...
void album_repository::deleteAlbum(const models::album &album, types::album_filter filter)
{
...
std::vector<models::album> album_repository::parseRecords(MYSQL_STMT *stmt)
{
...
std::vector<std::pair<models::album, int>> album_repository::parse_records_with_song_count(MYSQL_STMT *stmt)
{
    std::cout << "parsing album record with song count\n";
    mysql_stmt_store_result(stmt);

    std::vector<std::pair<models::album, int>> albums;
    albums.reserve(mysql_stmt_num_rows(stmt));
...
std::shared_ptr<MYSQL_BIND> album_repository::valueBind(models::album &album, 
...
std::shared_ptr<MYSQL_BIND> album_repository::valueBindWithSongCount(models::album &album, 
...
std::tuple<char*, char*> album_repository::metadataBuffer()
{
    constexpr auto wordLen = 1024;
    char title[wordLen];
    char artist[wordLen];
